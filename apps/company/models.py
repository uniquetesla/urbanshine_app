...
class CompanySettings(models.Model):
    ...
    tax_id = models.CharField(max_length=80, blank=True, verbose_name="Steuer-ID")
    phone = models.CharField(max_length=50, blank=True, verbose_name="Telefon")
    email = models.EmailField(blank=True, verbose_name="E-Mail")
    website = models.CharField(max_length=255, blank=True, verbose_name="Webseite")
    bank_name = models.CharField(max_length=180, blank=True, verbose_name="Bankname")
    ...
    kleinunternehmerregelung = models.BooleanField(default=True, verbose_name="Kleinunternehmerregelung (§19 UStG)")
